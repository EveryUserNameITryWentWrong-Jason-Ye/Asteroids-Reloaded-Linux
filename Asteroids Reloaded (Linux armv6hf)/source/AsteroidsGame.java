...
int scDamage = 0;
int scLevel = 1;
float scLvBar = 5.09375f;

//RandomCannon
int rcUpCost = 15;
int rcDamage = 0;
int rcLevel = 1;
float rcLvBar = 5.09375f;
float rcWidth = 0;
float rcHeight = 0;
...
int mbDamage = 0;
int mbLevel = 1;
float mbLvBar = 5.09375f;

 //Laser
int lsUpCost = 25;
int lsDamage = 0;
int lsLevel = 1;
float lsLvBar = 5.09375f;

 //Energy Shield
int esUpCost = 15;
int esDamage = 0;
int esLevel = 1;
float esLvBar = 5.09375f;
...
public void draw(){
 ...
 for(int a = 0; a < N46.size(); a++){
  ...
  if(wPressed && laserCharge > 0 && health > 0 && !dPressed && !rPressed && !gPressed && !Scan){
   ...
   N48.get(i).setDirectionX((Math.random()*2.4f) - 1.2f);
   N48.get(i).setDirectionY((Math.random()*2.4f) - 1.2f);
 ...
 if(frameCount > 571 && Bspawn && N50.size() == 0 && stage % 4 == 0){
   ...
   N50.get(nI).setDirectionX((Math.random()*2.4f) - 1.2f);
   N50.get(nI).setDirectionY((Math.random()*2.4f) - 1.2f);
 ...
 if(frameCount > 571 && megaBspawn && N51.size() == 0 && stage % 10 == 0){
   ...
   N51.get(nII).setDirectionX((Math.random()*1.2f) - 0.6f);
   N51.get(nII).setDirectionY((Math.random()*1.2f) - 0.6f);
 ...
 if(frameCount > 571 && icerSpawn && N52.size() == 0 && stage % 2 == 0){
   ...
   for(int NI = 0; NI < 1; NI++){
     ...
     N52.get(NI).setDirectionX((Math.random()*2.4f) - 1.2f);
     N52.get(NI).setDirectionY((Math.random()*2.4f) - 1.2f);;
...
//Laser Collision
 ...
 if(health > 0 && frameCount > 570){
  ...
  fill(255);
  textSize(18);
  text("Laser: " + (int)laserCharge + " %", 273, (int)(0.9255f*height));
  fill(207, 255, 0);
  noStroke();
  rect((int)(0.2778f*width), (int)(0.9333f*height), laserCharge, 40);
  stroke(255);
  noFill();
  rect((int)(0.2778f*width) - 1, (int)(0.9333f*height) - 1, 151, 41); 
  
  //EnergyShield Bar
  fill(255);
  textSize(18);
  text("Shield: " + (int)eShieldCount + " %", (int)(0.57f*width), (int)(0.9255f*height));
  fill(211, 255, 227);
  noStroke();
  rect((int)(0.55f*width), (int)(0.9333f*height), eShieldCount, 40);
  stroke(255);
  noFill();
  rect((int)(0.55f*width) - 1, (int)(0.9333f*height) - 1, 151, 41);

  //MegaBomb Bar
  fill(255);
  textSize(18);
  text("Mega Bomb: " + (int)shieldCount + " %", (int)(0.03889f*width), (int)(0.9255f*height));
  fill(45, 126, 255);
  noStroke();
  rect((int)(0.07333f*width), (int)(0.9333f*height), shieldCount, 40);
  stroke(255);
  noFill();
  rect((int)(0.07333f*width) - 1, (int)(0.9333f*height) - 1, 101, 41);

  //Ship Health Bar
  fill(255);
  textSize(18);
  text("Health: " + (int)((health/maxHealth)*100) + " %", (int)(0.79333f*width), (int)(0.9255f*height));
  if(health/maxHealth > 0.45f){
    fill(66, 244, 69);
  }
  if(health/maxHealth > 0.2f && health/maxHealth <= 0.45f){
    fill(255, 161, 0);
  }
  if(health/maxHealth > 0 && health/maxHealth <= 0.2f){
    fill(232, 4, 4);
  }
  noStroke();
  rect((int)(0.8111f*width), (int)(0.9333f*height), (health/maxHealth)*100, 40);
  stroke(255);
  noFill();
  rect((int)(0.8111f*width) - 1, (int)(0.9333f*height) - 1, 101, 41);
 ...
 for(int a = 0; a < N106.size(); a++){
  ...
  if(!(mouseX >= 52 && mouseX <= 217 && mouseY >= 149 + 154 && mouseY <= 192 + 154) && !(mouseX >= 52 && mouseX <= 217 && mouseY >= 149 + 154 + 77 && mouseY <= 192 + 154 + 77) && !(mouseX >= 52 && mouseX <= 217 && mouseY >= 149 + 154 + 154 + 154 + 77 && mouseY <= 192 + 154 + 154 + 154 + 77)){
   ...
   rect(54.0f, 116.0f, mcLvBar, 19.0f);
   stroke(255);
   noFill();
   rect(53, 115, 164, 20);
   ...
   rect(54.0f, 193.0f, wcLvBar, 19.0f);
   stroke(255);
   noFill();
   rect(53, 192, 164, 20);
   ...
   rect(54.0f, 193.0f + 77.0f, scLvBar, 19.0f);
   stroke(255);
   noFill();
   ...
   rect(54.0f, 193.0f + 154.0f, rcLvBar, 19.0f);
   stroke(255);
   noFill();
   ...
   rect(54.0f, 193.0f + 154.0f + 77.0f, mbLvBar, 19.0f);
   stroke(255);
   noFill();
   ...
   rect(54.0f, 193.0f + 154.0f + 154.0f, lsLvBar, 19.0f);
   stroke(255);
   noFill();
   ...
   rect(54.0f, 193.0f + 154.0f + 154.0f + 77.0f, esLvBar, 19.0f);
   stroke(255);
   noFill();
 ...
 if(frameCount % (20 - rcFireUp) == 0){
   ...
   rect(54.0f, 193.0f + 154.0f + 154.0f + 154.0f, frLvBar, 19.0f);
   stroke(255);
   noFill();
   ...
   rect(54.0f, 193.0f + 154.0f + 154.0f + 154.0f + 77.0f, mhLvBar, 19.0f);
   stroke(255);
   noFill();
 ...
 if(isOverShip && key > 'e' && key < 'g' && frameCount > 565 || isOverShip && key > 'E' && key < 'G' && frameCount > 565){
  ...
  if(frameCount < 565){
   ...
   fill(255, 106, 46);
   noStroke();
   rect((int)(0.18f*width), (int)(0.889f*height), loadBar, 40);
   noFill();
   stroke(255);
   rect((int)(0.18f*width) - 1, (int)(0.889f*height) - 1, 566, 41);
   textSize(18);
   fill(255);
   text("Loading: " + (int)Percent + " %", (int)(0.18f*width), (int)(0.867f*height));
  }
  if(frameCount < 560){
   fill(255, 0, 0, 200);
...
class Asteroid extends Floater{ 
  ...
  public void setDirectionX(double x) {
   ...
   public Asteroid() {
     ...
     float size = (float)(Math.random()*2.1f) + 4;
     corners = 6;
...
class eShield extends Floater{
  ...
  public eShield(Spaceship theShip){
  ...
  public void show(){
    ...
    fill(56 + (int)(Math.random()*61) - 30, 242 + (int)(Math.random()*61) - 30, 123 + (int)(Math.random()*61) - 30, 150);
...
class Bullet extends Floater{
  ...
  public Bullet(Spaceship theShip){
    ...
    myCenterX = theShip.getX();
    myCenterY = theShip.getY();
    myPointDirection = theShip.getPointDirection() + (int)(Math.random()*9) - 4;
    double dRadians = myPointDirection*(Math.PI/180);
  ...
  public void show(){
    ...
    noStroke();
    fill(255, 0 + (int)(Math.random()*120), 0 + (int)(Math.random()*120));
    ellipse(30, 0, 25 + widthAdd, 4 + heightAdd);
...
class MegaBossCoins extends Floater{ 
  ...
  {      
    ...
    textSize(40);
    fill(0, 0, 0);
    text('$', (int)myCenterX - 12, (int)myCenterY + 14);
...
class MegaBossteroid extends Floater{ 
  ...
  public void setDirectionX(double x) {
   ...
   public MegaBossteroid() {
     
     float size = (float)(Math.random()*4) + 24;
     corners = 6;
     xCorners = new float[corners];
     yCorners = new float[corners];
...
class RandomCannon extends Floater{
  ...
  public void show(){
    ...
    noStroke();
    fill(254, 255, 0);
    ellipse(30, 0, 10 + widthAdd, 4 + heightAdd);
...
class RegCoins extends Floater{ 
  ...
  {      
    ...
    textSize(20);
    fill(0, 0, 0);
    text('$', (int)myCenterX - 6, (int)myCenterY + 7);
...
{  
  ...
  public void Exhaust(){
   ...
   public Spaceship() {
    ...
    //3
    xCorners[2] = 5*3.5f;
    yCorners[2] = 2.5f*3.5f;
    //4
    xCorners[3] = 3*3.5f;
    yCorners[3] = 1*3.5f;
    //5
    xCorners[4] = 1*3.5f;
    yCorners[4] = 1.5f*3.5f;
    //6
    xCorners[5] = 4*3.5f;
    yCorners[5] = 11*3.5f;
    //7
    ...
    yCorners[11] = 2*3.5f;
    //13
    xCorners[12] = -4.5f*3.5f;
    yCorners[12] = 1*3.5f;
    //14
    xCorners[13] = -4.5f*3.5f;
    yCorners[13] = -1*3.5f;
    //15
    xCorners[14] = -3*3.5f;
    yCorners[14] = -2*3.5f;
    ...
    //22
    xCorners[21] = 1*3.5f;
    yCorners[21] = -1.5f*3.5f;
    //23
    xCorners[22] = 3*3.5f;
    yCorners[22] = -1*3.5f;
    //24
    xCorners[23] = 5*3.5f;
    yCorners[23] = -2.5f*3.5f;
    //25
    xCorners[24] = 14*3.5f;
    yCorners[24] = -1*3.5f;
...
class WingCannon extends Floater{
  ...
  public WingCannon(Spaceship theShip){
